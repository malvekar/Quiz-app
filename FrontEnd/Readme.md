...
Tkinter Desiner is a software which is used to convert figma designs into python code which uses tkinter module. The original project is created by [Parth Jadhav](https://github.com/ParthJadhav) can be found [here](https://github.com/ParthJadhav/Tkinter-Designer).
...
>
> I am going to use the option three that why i have created this FrontEnd folder specially, otherwise if you use option 1 or 2, you can directly use it.
...
>
> You dont really have to worry about this section, with practice and experiment you will learn faster, so can skip for the first time. Directly go to : [[Using Tkinter Designer](#using-tkinter-designer-top)] section
...
1. Open TKinter Designer GUI by, from the parent directory of the project run

```
python3 .\FrontEnd\Tkinter-Designer\gui\gui.py
```
